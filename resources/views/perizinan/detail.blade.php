                    ...
                    <div class="table-responsive">
                        <table width="100%" class="table table-bordered" style="overflow-x: scroll;">
                            ...
                            <tr>
                                ...
                                <td>: {{ $perizinan->santri->no_telp }} <br> <a href=""
                                        ...
                                        <tbody>
                                            @forelse($historyIzin as $history)
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($history->status == 0)
                                                            <span class="badge badge-pill badge-danger text-white">Not
                                                                Verify</span>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" data-placeholder="Pilih Santri"
                                                ...
                                                @foreach ($masterSantri as $mSantri)
                                                    <option value="{{ $mSantri->santri->id }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="keterangan" class="form-control" id="" cols="10" rows="3" required>{{ $perizinan->keterangan }}</textarea>
                                        </div>
                                        <div class="form-group">
