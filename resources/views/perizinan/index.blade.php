                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $item->santri->detail->kamar->gedung->kampus }} {{
                                    ...
                                    $item->santri->detail->kamar->kamar
                                    }}</td>
                                <td>{{ $item->santri->jenjang }} {{ $item->santri->kelas }}</td>
                                <td><span class="badge badge-secondary badge-pill">{{ $item->nama_perizinan }}</span> -
                                    {{ $item->keterangan }}</td>
                                ...
                                <td>
                                    ...
                                    @endif
                                    <a href="{{ route('perizinan.show',$item->id) }}" class="badge badge-pill bg-info"
                                        href="">Detail</a>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <input required type="date" name="tanggal_kembali" id="" class="form-control">
                            </div>
                        </div>
                    </div>
            </div>
