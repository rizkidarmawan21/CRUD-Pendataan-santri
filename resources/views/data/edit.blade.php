                  ...
                  <div class="row">
                      <div class="col-lg-6">
                        <div class="form-group ">
                          ...
                          <input type="text" class="form-control @error('nama') is-invalid @enderror " value="{{ old('nama',$data->nama) }}" id="nama" placeholder="Nama santri" name="nama">
                            @error('nama')
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" value="{{ old('alamat', $data->alamat) }}" class="form-control @error('alamat')
                            is-invalid
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" value="{{ old('no_telp',$data->no_telp) }}" class="form-control @error('no_telp') is-invalid @enderror" id="no_telp" placeholder="No Telepon santri" name="no_telp">
                          @error('no_telp')
                          <span class="invalid-feedback">
                              {{ $message }}
                          </span>
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control @error('nama_ortu') is-invalid @enderror" value="{{ old('nama_ortu',$data->nama_ortu) }}" id="nama_ortu" placeholder="Nama Wali" name="nama_ortu" >
                          @error('nama_ortu')
                          <span class="invalid-feedback">
                              {{ $message }}
                          </span>
                      ...
                      <div class="col-lg-6">
                        <div class="form-group">
                          ...
                          <select class="custom-select  @error('gedung') is-invalid @enderror" id="gedung" name="gedung">
                            ...
                            @foreach ($gedungKampus1 as $dataG )
                            @if (old('gedung') == $dataG->gedung)
                            <option value="{{ $dataG->gedung }}" selected>{{ $dataG->gedung }}</option>
                            @else
                            <option value="{{ $dataG->gedung }}">{{ $dataG->gedung }}</option>
                            @endif
                            @endforeach
                            <option disabled>----------------- Kampus 2 -----------------</option>
                            @foreach ($gedungKampus2 as $dataG )
                            @if (old('gedung') == $dataG->gedung)
                            <option value="{{ $dataG->gedung }}" selected>{{ $dataG->gedung }}</option>
                            @else
                            <option value="{{ $dataG->gedung }}">{{ $dataG->gedung }}</option>
                            ...
                            @foreach ($gedungKampus3 as $dataG )
                            @if (old('gedung') == $dataG->gedung)
                            <option value="{{ $dataG->gedung }}" selected>{{ $dataG->gedung }}</option>
                            @else
                            <option value="{{ $dataG->gedung }}">{{ $dataG->gedung }}</option>
                            ...
                            @foreach ($gedungKampus4 as $dataG )
                              @if (old('gedung') == $dataG->gedung)
                                  <option value="{{ $dataG->gedung }}" selected>{{ $dataG->gedung }}</option>
                              @else
                                  <option value="{{ $dataG->gedung }}">{{ $dataG->gedung }}</option>
                        ...
                        <div class="form-group">
                          ...
                          <input type="number" value="{{ old('kamar',$data->kamar) }}" class="form-control  @error('kamar') is-invalid @enderror" id="kamar" placeholder="Kamar" name="kamar" >
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" value="{{ old('kelas',$data->kelas) }}" class="form-control  @error('kelas') is-invalid @enderror" id="kelas" placeholder="Kelas" name="kelas" >
                          <small  class="form-text text-muted">
                            Ex : 7D ,12 TKJ , 11 IPA
                          </small>
                          @error('kelas')
