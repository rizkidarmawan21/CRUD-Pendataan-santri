        ...
        <div class="col-lg-6">
          <div class="form-group ">
            ...
            <input type="text" class="form-control @error('nama') is-invalid @enderror "
              value="{{ old('nama',$data->nama) }}" id="nama" placeholder="Nama santri" name="nama">
            @error('nama')
          ...
          <div class="form-group">
            ...
            <input type="text" value="{{ old('no_telp',$data->no_telp) }}"
              class="form-control @error('no_telp') is-invalid @enderror" id="no_telp" placeholder="No Telepon santri"
              name="no_telp">
            @error('no_telp')
            <span class="invalid-feedback">
              {{ $message }}
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control @error('nama_ortu') is-invalid @enderror"
              value="{{ old('nama_ortu',$data->nama_ortu) }}" id="nama_ortu" placeholder="Nama Wali" name="nama_ortu">
            @error('nama_ortu')
            <span class="invalid-feedback">
              {{ $message }}
            </span>
          ...
          <div class="form-group">
            ...
            <input type="text" value="{{ old('kelas',$data->kelas) }}"
              class="form-control  @error('kelas') is-invalid @enderror" id="kelas" placeholder="Kelas" name="kelas">
